...
MODEL_NAME:   str = os.getenv("MODEL_NAME_INTERNVL")
MODEL_FOR_TOKENIZER: str = os.getenv("MODEL_FOR_TOKENIZER_INTERNVL")
...
def create_output_directory():
    ...
    shell_scripts = [
        script_dir / "start_vllm_with_internvl.sh",
        script_dir / "start_vllm_with_intern.sh",
